...
export const TableHeader = React.forwardRef<HTMLTableSectionElement, React.HTMLAttributes<HTMLTableSectionElement>>(
  ({ className, ...props }, ref) => (
    <thead ref={ref} className={cn('bg-slate-50 text-xs font-semibold uppercase tracking-wider text-slate-600 border-b border-slate-200', className)} {...props} />
  )
);
...
export const TableHead = React.forwardRef<HTMLTableCellElement, React.ThHTMLAttributes<HTMLTableCellElement>>(
  ({ className, ...props }, ref) => (
    <th ref={ref} className={cn('px-4 py-3.5 align-middle font-medium text-slate-700', className)} {...props} />
  )
);
